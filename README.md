...
Please see my completed Leaflet challenge. For now, I have only completed Part 1 of the challenge. You will see that I chose to visualize earthquakes with a magnitude of at least 4.5 rather than all the earthquakes over the past month. Though the legend features magnitude levels below 4.5, you will not see these earthquakes plotted on the map. 
